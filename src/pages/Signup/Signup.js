...
export const Signup = () => {
    ...
    const renderButton = () => {
        if (formStep > 2) {
            ...
            return (
                <Button disabled={!isValid} type="submit" className="signupBtn" onClick={() => history.push("/")}>
                    Create Account
                </Button>
            );
        } else {
            return (
                <Button disabled={!isValid} onClick={completeFormStep} className="signupBtn" type="button">
                    Next Step
                </Button>
            );
        }
                    ...
                    <div className="card">
                        ...
                        <div sm={6} xs={12} className="p-fluid">
                            <Form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                {formStep === 3 && <h2>Account Created!</h2>}
                                <br />
                                {renderButton()}
                                {/* <pre>
